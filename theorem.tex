...
\newtheoremstyle{theoremstyle}
  ...
  {\thmname{#1}~\thmnumber{#2}:~\textcolor{black}{\thmnote{[#3]}}} % Theorem head spec (can be left empty, meaning ‘normal’)
...
\surroundwithmdframed[style=lemmaframe]{corollary}
...
\newtcolorbox[auto counter, number within=section]{question}[2][]{colframe=fuyu-gaki, colback=mizu!10, coltitle=white, title={Open Question \thetcbcounter: #2}, sharp corners, boxrule=0.8mm, width=0.99\textwidth, boxsep=2mm, left=3mm, right=3mm, top=2mm, bottom=2mm, breakable}
